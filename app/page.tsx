	...
	return (
		<div>
			...
			<p>
				...
				<br />
				Mon objectif est de collaborer avec une équipe expérimentée et innovante
				pour continuer à développer mes compétences et contribuer à des projets
				passionnants.
				<br />
				N'hésitez pas à explorer mon profil et à me contacter si vous cherchez
				une personne motivée et passionnée pour rejoindre votre équipe.
				<br />
